      ...
      <li class="nav-item">
        ...
        <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="<?= base_url('Apriori/indexhasil') ?>"><i class="fas fa-fw fa-poll"></i> Hasil Perhitungan</a>
          </div>
        </div>
      </li>
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="<?= base_url('Alternatif/indexperhitunganspk') ?>"><i class="fas fa-fw fa-calculator"></i> Perhitungan SPK</a>
            <a class="collapse-item" href="<?= base_url('Alternatif/indexhasil') ?>"><i class="fas fa-fw fa-poll"></i> Hasil SPK</a>
          </div>
        </div>
      </li>
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <ul class="na navbar-nav navbar-right">
                ...
                <?php if ($this->session->userdata('role_id')) { ?>
                  <li><div>Selamat Datang, Manager. </div></li>
