...
<div class="container-fluid">
  ...
  <a href="<?= base_url('Apriori/reset') ?>" class="btn btn-danger mb-3"><i class="fa fa-trash"></i> Reset Perhitungan </a>
  <!--<a href="<?= base_url('Apriori/input_alter') ?>" class="btn btn-success mb-3"> Jadikan Alternatif dari SPK <i class="fa fa-arrow-right"></i></a>-->